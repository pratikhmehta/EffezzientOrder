                                      ...
                                      type:(NSUInteger)type
{
    ...
    if (self)
    {
        ...
        if (type == 0)
        {
            ...
            self.leftViewStatusBarVisibleOptions = LGSideMenuStatusBarVisibleOnAll;//None;
...
-(void)setleftViewSwipeGestureEnabled:(BOOL)enabled
{
    self.leftViewSwipeGestureEnabled = enabled;
//    self.rightViewSwipeGestureEnabled = enabled;
}

-(void)setRightViewSwipeGestureEnabled:(BOOL)enabled
{
    self.rightViewSwipeGestureEnabled = enabled;
}
